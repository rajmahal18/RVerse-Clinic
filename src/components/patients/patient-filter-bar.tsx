  ...
  return (
    <form action="/patients" onChange={(event) => event.currentTarget.requestSubmit()} className="mb-4 border bg-white px-3 py-3 shadow-sm">
      ...
      <div className="grid grid-cols-2 items-end gap-x-2 gap-y-2 sm:flex sm:flex-wrap">
        ...
        <SelectField label="Last Visit" name="lastVisit" value={filters.lastVisit} className="col-start-2">
        ...
        <SelectField label="Request" name="request" value={filters.request} className="col-start-1">
        ...
        <SelectField label="Office" name="agency" value={filters.agency} className="col-start-2">
        ...
        <SelectField label="Gender" name="gender" value={filters.gender} className="col-start-1">
        ...
        <SelectField label="Age" name="ageGroup" value={filters.ageGroup} className="col-start-2">
        ...
        <label className="col-start-1 grid min-w-0 gap-1 text-xs font-bold uppercase tracking-wide text-slate-500 sm:min-w-[11rem] sm:flex-[2_1_16rem]">
          Sort
        ...
        <Button asChild variant="outline" size="sm" className="col-start-2 h-10">
